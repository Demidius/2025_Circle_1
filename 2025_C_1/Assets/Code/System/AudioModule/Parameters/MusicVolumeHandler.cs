...
namespace CodeBase.System.GameSystems.AudioModule.Parameters
{
    public class MusicVolumeHandler : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            _currentVolume = _settings.MusicVolume;
            ...
            FMODUnity.RuntimeManager.StudioSystem.setParameterByName(Const.Musicvolume, _currentVolume);
        }
        ...
        private void OnSliderChanged(Slider changedSlider, float volume)
        {
            ...
            FMODUnity.RuntimeManager.StudioSystem.setParameterByName(Const.Musicvolume, volume);

            // Синхронизация между двумя "меню"-слайдерами
